...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Create expense
        $stmt = $pdo->prepare("INSERT INTO expenses (group_id, paid_by, amount, description, created_at) VALUES (?, ?, ?, ?, NOW())");
        $stmt->execute([$group_id, $_SESSION['user_id'], $amount, $description]);
